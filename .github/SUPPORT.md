# Getting help with natverse

Thanks for using natverse. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the natverse package](https://github.com/natverse/natverse/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/natverse/issues/new).
* If you're not sure:
